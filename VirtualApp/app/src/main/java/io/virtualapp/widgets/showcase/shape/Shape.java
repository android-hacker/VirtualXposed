...
/**
 * Specifies a shape of the target (e.g circle, rectangle). Implementations of
 * this interface will be responsible to draw the shape at specified center
 * point (x, y).
 */
public interface Shape {

	/**
	 * Draw shape on the canvas with the center at (x, y) using Paint object
	 * provided.
	 */
