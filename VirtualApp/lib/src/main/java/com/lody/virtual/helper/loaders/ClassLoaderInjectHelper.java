...
class ClassLoaderInjectHelper {
	...
	private static Object[] makePathElements(List<File> files, File optimizedDirectory,
			List<IOException> suppressedExceptions) throws Exception {
	...
	private static final class V14 {
		...
		private static void install(ClassLoader loader, List<File> additionalClassPathEntries, File optimizedDirectory)
			...
			ClassLoaderInjectHelper.expandFieldArray(dexPathList, "dexElements",
					makeDexElements(dexPathList, new ArrayList<>(additionalClassPathEntries), optimizedDirectory));
		}
		...
		private static Object[] makeDexElements(Object dexPathList, ArrayList<File> files, File optimizedDirectory)
			...
			try {
				...
				e.printStackTrace();
				return (Object[]) ClassLoaderInjectHelper
						.findMethod(dexPathList, "makeDexElements", ArrayList.class, File.class)
						.invoke(dexPathList, files, optimizedDirectory);
			}
		}
	}
	...
	private static final class V19 {
		...
		private static void install(ClassLoader loader, List<File> additionalClassPathEntries, File optimizedDirectory)
			...
			ClassLoaderInjectHelper.expandFieldArray(dexPathList, "dexElements", makeDexElements(dexPathList,
			...
			if (suppressedExceptions.size() > 0) {
				...
				Field suppressedExceptionsField = ClassLoaderInjectHelper.findField(loader,
		...
		private static Object[] makeDexElements(Object dexPathList, ArrayList<File> files, File optimizedDirectory,
			...
			try {
				...
				return (Object[]) ClassLoaderInjectHelper
						...
						.invoke(dexPathList, files, optimizedDirectory, suppressedExceptions);
			}
		}
	}
