 ...
 */
/* package */ class Hook_RemoveOnSubscriptionsChangedListener extends Hook<TelephonyRegistryPatch> {
	/**
	 * 这个构造器必须有,用于依赖注入.
	 *
	 * @param patchObject
	 *            注入对象
	 */
	public Hook_RemoveOnSubscriptionsChangedListener(TelephonyRegistryPatch patchObject) {
		super(patchObject);
	}
