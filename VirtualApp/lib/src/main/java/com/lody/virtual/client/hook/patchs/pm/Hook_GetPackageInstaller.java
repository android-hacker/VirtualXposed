...
/*package*/ class Hook_GetPackageInstaller extends Hook<PackageManagerPatch> {
    /**
     * 这个构造器必须有,用于依赖注入.
     *
     * @param patchObject 注入对象
     */
    public Hook_GetPackageInstaller(PackageManagerPatch patchObject) {
        super(patchObject);
    }
    ...
    public Object onHook(final Object who, Method method, Object... args) throws Throwable {
        ...
        return Proxy.newProxyInstance(installer.getClass().getClassLoader(), new Class[] {IPackageInstaller.class}, new InvocationHandler() {
            @Override
