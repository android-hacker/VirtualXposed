...
public class Constants {
    ...
    public static final String XPRIVACY_LUA_PACKAGE = "eu.faircode.xlua";
    public static final String XPRIVACY_LUA_DB_FOLDER = Environment.getDataDirectory() + File.separator + "system" + File.separator + "xlua";
}
