...
/**
 * A cache of services that export the {@link IAccountAuthenticator} interface.
 * This cache is built by interrogating the {@link PackageManager} and is
 * updated as packages are added, removed and changed. The authenticators are
 * referred to by their account type and are made available via the
 * {@link RegisteredServicesCache#getServiceInfo} method.
 */
/* package private */ class AccountAuthenticatorCache extends RegisteredServicesCache<AuthenticatorDescription>
		implements
	...
	public AccountAuthenticatorCache(Context context) {
		super(context, AccountManager.ACTION_AUTHENTICATOR_INTENT, AccountManager.AUTHENTICATOR_META_DATA_NAME,
	...
	public AuthenticatorDescription parseServiceAttributes(Resources res, String packageName, AttributeSet attrs) {
		...
		try {
			...
			final int smallIconId = sa.getResourceId(com.android.internal.R.styleable.AccountAuthenticator_smallIcon,
					0);
			final int prefId = sa
					.getResourceId(com.android.internal.R.styleable.AccountAuthenticator_accountPreferences, 0);
			final boolean customTokens = sa
					.getBoolean(com.android.internal.R.styleable.AccountAuthenticator_customTokens, false);
