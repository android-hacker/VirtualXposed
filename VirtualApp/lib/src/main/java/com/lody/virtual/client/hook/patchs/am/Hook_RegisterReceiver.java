...
/* package */ class Hook_RegisterReceiver extends Hook {
  ...
  public Object onHook(Object who, Method method, Object... args) throws Throwable {
    ...
    final int indexOfIntentFilter = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? 3 : 2;
    IApplicationThread iApplicationThread = (IApplicationThread) args[0];
    IntentFilter intentFilter = (IntentFilter) args[indexOfIntentFilter];
    ...
    final int indexOfUserId = Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH_MR1 ? 5 : -1;
    int userId = -1;
    if (indexOfUserId != -1)
      userId = (int) args[5];
    if (args != null && args.length > indexOfIIntentReceiver
      ...
      if (!ProxyIIntentReceiver.class.isInstance(old)) {
        ...
        try {
          ...
          VReceiverService.addIntentReceiver(iApplicationThread.asBinder(),
                  proxyIIntentReceiver, intentFilter, permission, userId);
        } catch (Throwable e) {
          e.printStackTrace();
        }
      }
