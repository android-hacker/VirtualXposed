...
public class VAccountManager {
	...
	public void confirmCredentials(IAccountManagerResponse response, Account account, Bundle options,
	...
	public void getAuthToken(IAccountManagerResponse response, Account account, String authTokenType,
			boolean notifyOnAuthFailure, boolean expectActivityLaunch, Bundle options) throws RemoteException {
		getRemote().getAuthToken(response, account, authTokenType, notifyOnAuthFailure, expectActivityLaunch, options);
	}

	public void addAcount(IAccountManagerResponse response, String accountType, String authTokenType,
	...
	public void updateCredentials(IAccountManagerResponse response, Account account, String authTokenType,
			boolean expectActivityLaunch, Bundle options) throws RemoteException {
	...
	public void getAuthTokenLabel(IAccountManagerResponse response, String authType, String authTokenType)
			throws RemoteException {
